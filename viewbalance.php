...
$sql = 'SELECT balance FROM accounts WHERE user_id = 1234 AND account_type = "Checking"';
...
$sql = 'SELECT balance FROM accounts WHERE user_id = 1234 AND account_type = "Savings"';
